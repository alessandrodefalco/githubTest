...
DOO2_SEL_CHIC=0     # hf-chic-tojpsigamma-candidate-selector PROBLEM HERE
# User tasks
...
DOO2_TASK_CHIC=0     # hf-task-chic PROBLEM HERE
# Tree creators
...
APPLYCUTS_CHIC=0    # Apply chic selection cuts.
